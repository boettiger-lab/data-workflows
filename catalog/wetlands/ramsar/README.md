...
3. **WDPA database**: `s3://public-wdpa/wdpa.parquet` - used for fuzzy matching missing sites (canonical date-independent collection; the superseded `wdpa-december-2025` edition it previously read was purged in #332)
