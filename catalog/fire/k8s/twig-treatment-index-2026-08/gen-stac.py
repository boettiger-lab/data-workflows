...
DESC = (
 ...
 "agency's reporting. It complements rather than replaces the Forest Service FACTS Common Attributes "
 "collection in this catalogue: 737,013 of these records come from that same Forest Service source but "
 "carry a reduced set of attributes, so combining the two collections would count those treatments twice.\n\n"
