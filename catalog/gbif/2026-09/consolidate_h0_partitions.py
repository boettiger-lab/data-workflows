"""
GBIF 2026-09 — Stage 2: consolidate each h0 partition (port of
catalog/gbif/2026-06/consolidate_h0_partitions.py).

Per JOB_COMPLETION_INDEX, picks one h0 partition under 2026-09/chunks/, reads all
its Stage-1 files, and writes ONE optimized file 2026-09/hex/h0=<int>/data_0.parquet.

Unchanged from 2026-06 apart from the 2026-06 -> 2026-09 prefixes
(data-workflows#662). Properties that must not regress:
...
BUCKET = "public-gbif"
IN_PREFIX = "2026-09/chunks"
OUT_PREFIX = "2026-09/hex"
