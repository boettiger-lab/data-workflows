...
- **OK** · `public-domain` — public-blm/locatable-operations  · BLM National MLRS locatable-mineral operations — Notices + Plans of Operations (ArcGIS FeatureServer, gis.blm.gov). US federal cadastral work → public domain. Mirror-eligible. Tracked: data-workflows #487. (Backfilled — the collection shipped without a license-inventory line.)
- **OK** · `public-domain` — public-blm/coal-cases  · BLM National MLRS Coal Cases (ArcGIS FeatureServer `BLM_Natl_MLRS_Coal_Cases/FeatureServer/1`, gis.blm.gov). US federal cadastral work → public domain. Mirror-eligible. Tracked: data-workflows #486.
- **OK** · `public-domain` — public-blm/geothermal-leases  · BLM National MLRS Geothermal Leases (ArcGIS FeatureServer, gis.blm.gov). US federal cadastral work → public domain. Mirror-eligible. Tracked: data-workflows #486.
- **OK** · `public-domain` — public-blm/oil-shale-leases  · BLM National MLRS Oil Shale Leases (RD&D, preference-right and exploration licenses; ArcGIS FeatureServer, gis.blm.gov). US federal cadastral work → public domain. Mirror-eligible. Tracked: data-workflows #486.
- **OK** · `public-domain` — public-blm/non-energy-leasables  · BLM National MLRS Non-Energy Leasables (phosphate, sodium, potassium, sulfur, gilsonite, etc.; ArcGIS FeatureServer, gis.blm.gov). US federal cadastral work → public domain. Mirror-eligible. Tracked: data-workflows #486.
...
- **OK** · `CC-BY-4.0` — public-ca30x30/ecoregion  · CDFW / CNRA ACE Bailey-derived California ecoregions, CNRA Open Data ([ACE dataset page](https://data.cnra.ca.gov/dataset/areas-of-conservation-emphasis-ace)). CC-BY. Mirror-eligible.
- **OK** · `CC-BY-4.0` — public-ca30x30/conserved-areas-terrestrial-2025  · CA Nature / CNRA 30x30 Conserved Areas (Terrestrial), 2025 edition. CC-BY-4.0 per the FGDC metadata `useconst`. Mirror-eligible.
- **OK** · `CC-BY-4.0` — public-ca30x30/2024/conserved-areas-terrestrial  · same CA Nature / CNRA product, 2024 edition. Mirror-eligible.
- **OK** · `ODC-By-1.0` — public-ca30x30/groundwater-dependent-ecosystems  · Klausmeyer et al. (2018) TNC groundwater-dependent ecosystems. Open Data Commons Attribution — redistribution permitted with attribution. Mirror-eligible.
- **OK** · `CC-BY-4.0` — public-ca30x30/cwhr13  · CAL FIRE FRAP FVEG (fveg22_1) CWHR 13-class generalization. Terms confirmed on the state's own portal: [data.ca.gov "California Vegetation - WHR13 Types"](https://data.ca.gov/dataset/california-vegetation-whr13-types), publisher CAL FIRE, `license_id: cc-by`. **STAC corrected from `other` → `CC-BY-4.0` (data-workflows #522 follow-up)** — the fire.ca.gov FRAP landing page states no terms, which is why it was originally recorded as `other`. Mirror-eligible.
- **OK** · `CC-BY-4.0` — public-ca30x30/cwhr  · same CAL FIRE FVEG source, detailed 60+ class CWHR classification: [data.ca.gov "California Vegetation - WHRTYPE"](https://data.ca.gov/dataset/california-vegetation-whrtype), `license_id: cc-by`. STAC likewise corrected from `other`. Mirror-eligible.
- **OK** · `public-domain` — public-ca30x30/fmmp-2022  · California Dept. of Conservation Farmland Mapping & Monitoring Program 2022. State-agency public record. Mirror-eligible.
- **OK** · `public-domain` — public-ca30x30/williamson-act  · California Dept. of Conservation Williamson Act enrollment (2021–2025). State-agency public record. Mirror-eligible.
- **OK** · `MIT` — public-ca30x30/ca-climate-zones  · Kling / Ackerly Lab (UC Berkeley) climate zones from BCM normals, source [github.com/matthewkling/climclust](https://github.com/matthewkling/climclust). Was briefly HOLD (the repo had no LICENSE file, `GET .../license` → 404). **Resolved 2026-08-12: the repo now carries an [MIT LICENSE](https://github.com/matthewkling/climclust/blob/master/LICENSE.md)** (Zenodo release [10.5281/zenodo.21890022](https://doi.org/10.5281/zenodo.21890022), `mit-license`). MIT is permissive (redistribution incl. derivatives permitted), so mirror-eligible. STAC corrected `other` → `MIT` with the LICENSE as the license link. The `EXCLUDES[ca30x30]` sub-path exclude was dropped.
